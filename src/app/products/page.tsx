...
export default function ProductsPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="fixed bottom-0 left-0 right-0 lg:hidden bg-background/95 backdrop-blur-md border-t shadow-[0_-4px_20px_rgba(0,0,0,0.1)] p-4 space-y-3 z-50">
        <Link href="/checkout" className="block">
          <Button className="w-full h-12 text-base font-semibold rounded-full shadow-lg shadow-primary/25">
