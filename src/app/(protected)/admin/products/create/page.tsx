            ...
            <form onSubmit={form.handleSubmit((data) => createMutation.mutate(data))} className="space-y-8">
                ...
                <div className="flex justify-end gap-4 pt-6 border-t border-gray-100">
                    ...
                    <button
                        ...
                        className="px-8 py-2.5 text-sm font-medium text-white bg-black rounded-lg hover:bg-[#1f3a4d] disabled:opacity-50 disabled:cursor-not-allowed shadow-md transition-all hover:shadow-lg flex items-center gap-2"
                    >
